...
mul = Button(
    ...
    padx=17,
    pady=15,
    command=lambda: multiplication("x"),
).grid(row=4, column=3)
div = Button(
    ui,
    activebackground="#ffe46b",
